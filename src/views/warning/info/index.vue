  ...
  <div class="app-containers">
    ...
    <el-card>
      ...
      >
        ...
        <el-table-column label="报警名称" width="180" align="center">
          <template slot-scope="scope">
            {{ scope.row.name }}
          </template>
        </el-table-column>

        <el-table-column label="报警详情" width="280" align="center">
          <template slot-scope="scope">
            <span>{{ scope.row.detail }}</span>
          </template>
        </el-table-column>

        <el-table-column label="报警联系人" width="180" align="center">
          <template slot-scope="scope">
            <span>{{ scope.row.people }}</span>
          </template>
        </el-table-column>

        <el-table-column label="报警级别" width="160" align="center">
          <template slot-scope="scope">
            <span>{{ scope.row.jibie }}</span>
          </template>
        </el-table-column>

        <el-table-column label="处理标志" width="160" align="center">
          <template slot-scope="scope">
  ...
  methods: {
    fetchData() {
      ...
      this.list = [
        {
          name:'到达极限报警',
          detail:'您的设备（XY23030161）,产生到达极限报警',
          people:'田小琴',
          jibie:'一般',
          handle:'未处理',
          time:'2025/06/06 08:58:34',
        },
        {
          name:'左倾斜报警',
          detail:'您的设备（XY23030118）,产生左倾斜报警',
          people:'徐敏',
          jibie:'一般',
          handle:'未处理',
          time:'2025/06/06 08:57:29',
        }
      ]
      this.listLoading = false;
      this.page.total = 2;
